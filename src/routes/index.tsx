...
const Insurers = React.lazy(() => import('../pages/administration/insurers'));
const Branches = React.lazy(() => import('../pages/administration/branches'));
const Sar = React.lazy(() => import('../pages/administration/sar'));
const VehicleTypes = React.lazy(() => import('../pages/administration/vehicleTypes'));
const VehicleTypeDetail = React.lazy(() => import('../pages/administration/vehicleTypes/detail'));
const inspectionList = React.lazy(() => import('../pages/administration/vehicleTypes/indexInspection'));
const evaluationList = React.lazy(() => import('../pages/administration/vehicleTypes/indexEvaluation'));

// Appraisal pages
const Customers = React.lazy(() => import('../pages/appraisal/customers'));
const Reception = React.lazy(() => import('../pages/appraisal/reception'));
const Appraisal = React.lazy(() => import('../pages/appraisal/appraisal'));
const Inspection = React.lazy(() => import('../pages/appraisal/inspection'));
const InspectionDetail = React.lazy(() => import('../pages/appraisal/inspection/inspectDetail'));
const Invoices = React.lazy(() => import('../pages/appraisal/invoices'));
const InvoiceDetail = React.lazy(() => import('../pages/appraisal/invoices/Invoice'));
const AppraisalDetail = React.lazy(() => import('../pages/appraisal/appraisal/appraisalDetail'));
const Certs = React.lazy(() => import('../pages/appraisal/certs'));
const CertDetail = React.lazy(() => import('../pages/appraisal/certs/certDetail'));
    ...
    return useRoutes([
        { path: '/', element: <Root /> },
        {
            ...
            children: [
                ...
                {
                    path: 'invoice-detail-backend/:id',
                    element: <LoadComponent component={InvoiceDetail} />,
                },
            ],
        },
        {
            ...
            path: '/',
            element: <PrivateRoute roles={'Admin,Recepcion,Avaluos,Inspeccion'} component={Layout} />,
            children: [
                {
                    path: 'home',
                ...
                },
                {
                    ...
                    children: [
                        ...
                        {
                            path: 'insurers',
                            element: <LoadComponent component={Insurers} />,
                        },
                        {
                            path: 'branches',
                            element: <LoadComponent component={Branches} />,
                        },
                        {
                            path: 'sar',
                            element: <LoadComponent component={Sar} />,
                        },
                        {
                            path: 'vehicle-types',
                            element: <LoadComponent component={VehicleTypes} />,
                        },
                        {
                            path: 'vehicle-type-detail/:id',
                            element: <LoadComponent component={VehicleTypeDetail} />,
                        },
                        {
                            path: 'vehicle-type/inspection-list/:id',
                            element: <LoadComponent component={inspectionList} />,
                        },
                        {
                            path: 'vehicle-type/evaluation-list/:id',
                            element: <LoadComponent component={evaluationList} />,
                        }
                    ]
                },
                {
                    ...
                    children: [
                        {
                            path: 'reception',
                            element: <LoadComponent component={Reception} />,
                        },
                        {
                            path: 'appraisal',
                            element: <LoadComponent component={Appraisal} />
                        },
                        {
                            path: 'appraisal-detail/:id',
                            element: <LoadComponent component={AppraisalDetail} />,
                        },
                        {
                            path: 'inspection',
                            element: <LoadComponent component={Inspection} />
                        },
                        {
                            path: 'inspection-detail/:id',
                            element: <LoadComponent component={InspectionDetail} />,
                        },
                        {
                            path: 'certs',
                            element: <LoadComponent component={Certs} />
                        },
                        {
                            path: 'cert-detail/:id/:appraisalId',
                            element: <LoadComponent component={CertDetail} />,
                        },
                        {
                            path: 'invoices',
